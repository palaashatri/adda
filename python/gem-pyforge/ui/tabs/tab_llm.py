...
class TabLLM(ctk.CTkFrame):
    ...
    def _generate(self, prompt: str):
        ...
        request = EngineRequest(prompt=prompt, model_id="", modality="llm")
        task_queue.submit_task("llm_gen", self._run_engine, request)
    ...
    def _on_success(self, output, prompt):
        ...
        self.history.add_history(f"LLM: {prompt[:20]}...")
